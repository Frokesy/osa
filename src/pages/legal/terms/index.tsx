      ...
      <div className="mt-20">
        <div className="flex flex-col items-center justify-center text-center shadow-xl w-[90vw] mx-auto rounded-2xl pb-10">
          ...
          <div>
            ...
            <p className="lg:text-[20px] text-[14px] pt-2 text-[#333]">
        ...
        <div className="mt-20 w-[90vw] mx-auto">
          <p className="text-[#5D5E5F] text-[16px]">
            Last updated: 01 Aug, 2025.
          </p>
          <p className="text-[#5D5E5F] text-[16px] pt-3">
          ...
          <div className="space-y-10 mt-10">
            <div className="">
              <h2 className="text-[#333] mb-2 font-semibold text-[36px]">
                1. Use of website
              </h2>
              <p className="text-[#5D5E5F] text-[16px]">
