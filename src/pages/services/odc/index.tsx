...
const OrganizationDevelopment = () => {
  const skillItems = [
    {
      id: 1,
      title: "Organizatinal diagnosis",
      description:
    ...
    {
      id: 2,
      title: "Organization design and conceptual models",
      description:
        "Our online course are unique and targeted to specific audiences. 1Stepahead being one Step ahead is a great way to learners in the driving sit.",
      features: [
    ...
    {
      id: 4,
      title: "Governance and corporate structures",
      description:
        "Our online course are unique and targeted to specific audiences. 1Stepahead being one Step ahead is a great way to learners in the driving sit.",
      features: [
        "Professional tutors to attend to your needs",
    ...
    {
      id: 5,
      title: "Functional structures and capabilities",
      description:
        "Our online course are unique and targeted to specific audiences. 1Stepahead being one Step ahead is a great way to learners in the driving sit.",
      features: [
        "Professional tutors to attend to your needs",
    ...
    {
      id: 6,
      title: "Shared services and support service function effectiveness",
      description:
        "Our online course are unique and targeted to specific audiences. 1Stepahead being one Step ahead is a great way to learners in the driving sit.",
      features: [
        "Professional tutors to attend to your needs",
  ...
  return (
    <div className="">
      <div className="bg-[url('/assets/services-twelve.png')] lg:min-h-screen h-[80vh] bg-center bg-cover bg-no-repeat">
      ...
      <div className="lg:mt-20 mt-10 w-[95vw] mx-auto">
        ...
        <p className="lg:text-[20px] text-[14px] pt-6 text-[#1D2939]">
          ...
          structures that will deliver maximum agility, flexibility and
